...
describe('User Registration', () => {
  ...
  it.each`
    ...
    ${'password'} | ${'lowerand5678'}  | ${en.password_pattern}
    ${'password'} | ${'UPPERAND5678'}  | ${en.password_pattern}
...
describe('Internationalization', () => {
  ...
  it.each`
    ...
    ${'password'} | ${'lowerand5678'}  | ${tr.password_pattern}
    ${'password'} | ${'UPPERAND5678'}  | ${tr.password_pattern}
  `(
  ...
  it(`returns success message of ${tr.user_create_success} when signup request is valid`, async () => {
    const response = await postUser({ ...validUser }, { language: 'tr' });
